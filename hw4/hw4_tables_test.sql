...
# FOREIGN KEY CONSTRAIN ON ccId references creditcards.id
INSERT INTO customers (email, firstName, lastName, ccId, address)
VALUES
    ('amcheng@uci.edu', 'Alex', 'Cheng', 'not_a_cc_in_creditcards', 'throw_away_address');

# FOREIGN KEY CONSTRAIN ON email references customers.email
INSERT INTO sales (email, movieId, quantity, saleDate)
VALUES
